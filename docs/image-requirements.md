# Futra Financial — Image Requirements

15 images needed (3 per business unit). Each image has a generation prompt ready for Midjourney, DALL-E, or similar tools.

**File naming:** Place in `src/assets/{bu}/` (e.g., `src/assets/spend/hero-lifestyle.jpg`)
**Format:** JPG for photos, PNG for textures with transparency. Optimize to <200KB each.
...
- **Placement:** Hero section, behind or alongside PhoneMockup
- **Subject:** Young professional (22-28) glancing at phone in urban setting — subway, cafe, or walking. Candid, not posed. Evening lighting.
...
- **Placement:** Feature section, accompanying "Real-Time Feed" or "Card Controls" card
- **Subject:** Close-up of hand holding a debit card, tapping a payment terminal. Modern, clean.
...
- **Dimensions:** 1200 x 800px
- **Placement:** Hero section, behind ProgressCards cluster
- **Subject:** Person (24-32) in calm bright space — sitting with planner/notebook, morning light, plants visible. Goal-setting mood.
...
- **Dimensions:** 800 x 600px
- **Placement:** Feature section or alongside ProgressCards as goal visualization
- **Subject:** Travel destination or aspirational scene — coastline, mountain view, charming street.
...
- **Dimensions:** 1200 x 800px
- **Placement:** Hero section, alongside or behind ScoreDisplay
- **Subject:** Person (25-33) looking confident and relieved — standing in doorway of new apartment, holding keys. The "I got approved" moment.
...
- **Subject:** Abstract architectural detail — vault door, clean modern building facade. Clinical precision.
...
- **Subject:** Abstract gradient or soft texture — frosted glass, water surface. Lavender-tinted.
...
- **Dimensions:** 1200 x 800px
- **Placement:** Hero section, behind or alongside DashboardPreview
- **Subject:** Overhead/angled view of clean desk with laptop showing charts, coffee, notebook. Evening lighting.
...
- **Subject:** Abstract data visualization — flowing lines, connected nodes, geometric grid. Dark background with indigo/teal accents.
...
- **Subject:** Night sky, star trails, or long-exposure city lights. Long-term horizon.
...
- **Dimensions:** 1200 x 800px
- **Placement:** Hero section, behind or alongside SplitDisplay + avatars
- **Subject:** Two people (25-35) in domestic setting — cooking together, at kitchen table. Warm, natural, collaborative.
- **Tone:** Warm, domestic, real. The "Sunday morning planning finances together" moment.
...
- **Dimensions:** 800 x 600px
- **Placement:** Feature section, accompanying "Shared savings goals" or "Smart bill splitting"
- **Subject:** Two people shopping together, moving into apartment, carrying grocery bags.
...
| IMG-SAVE-02 | Save | 800x600 | Travel destination | Feature/goal |
| IMG-SAVE-03 | Save | 1920x600 | Green leaves/nature | Section bg |
| IMG-CREDIT-01 | Credit | 1200x800 | Apartment keys, confident | Hero |
| IMG-CREDIT-02 | Credit | 800x600 | Modern architecture | Trust section |
| IMG-CREDIT-03 | Credit | 1920x600 | Frosted glass, lavender | Section bg |
| IMG-PLAN-01 | Plan | 1200x800 | Desk with charts, night | Hero |
| IMG-PLAN-02 | Plan | 800x600 | Abstract data viz | Feature bg |
